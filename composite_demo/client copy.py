...
MODEL_PATH_LIST = ['/mnt/workspace/Chatglm3-6b-summary3', '/mnt/workspace/chatglm3-6b']
...
def get_client() -> Client:
    # MODEL_PATH = MODEL_PATH_LIST[1] if model_type == 'Base with Prompt' else MODEL_PATH_LIST[0]
